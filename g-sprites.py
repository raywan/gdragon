...
class Player(Entity):
    ...
    def __init__(self, parent, init_pos):
        ...
        self.spritesheet = SpriteSheet("Characters.png")
...
class Tile(object) :
    def __init__(self) :
        ...
        ###
        self.cliff_grass_top_left = CliffGrassTopLeft()
        self.cliff_grass_middle_top = CliffGrassMiddleTop()
        self.cliff_grass_right_top = CliffGrassRightTop()
        
        self.cliff_grass_left_center = CliffGrassLeftCenter()
        self.cliff_grass_right_center = CliffGrassRightCenter()
...
class MainGrass (Entity) :
    def __init__(self):
        Entity.__init__(self)
        self.spritesheet = Spritesheet("Grass2.png")
        self.tile = self.Spritesheet.load((0,0,32,32), (255,0,255))
        self.mask = pygame.mask.from_suface(self.tile)
...
#from Cliff.png, first 96x96 square
        #top row
class CliffGrassTopLeft (Entity) :
    def __init__(self) :
        Entity.__init__(self)
...
class CliffGrassMiddleTop (Entity) :
    def __init__(self) :
        Entity.__init__(self)
        self.spritesheet = Spritesheet("CliffGrass.png")
...
class CliffGrassRightTop (Entity) :
    def __init__(self) :
        Entity.__init__(self)
        self.spritesheet = Spritesheet("CliffGrass.png")
        ...
        #middle row
class CliffGrassLeftCenter (Entity) :
    def __init__(self) :
        Entity.__init__(self)
        self.spritesheet = Spritesheet("CliffGrass.png")
...
class CliffGrassRightCenter (Entity) :
    def __init__(self) :
        Entity.__init__(self)
        self.spritesheet = Spritesheet("CliffGrass.png")
...
class 1x1Box (Entity) :
    def __init__(self) :
        Entity.__init__(self)
        self.spritesheet = Spritesheet("1x1PixelBox.png")
